...
W = Path("/data/peilincai/CyberPoetTraining/claude_parallel_20260825/vocab_probe")
pairs = json.load(open(W / "pairs_M1.json"))
# 网页里不暴露模型名，只留 gen_id
...
<header><b>诗歌偏好标注 · M1 轮数二选一</b>　<span id="n"></span>
