...
SETS = [("v3", "pairs_final.json", picks3), ("v5", "v5_pairs_final.json", picks56), ("v6", "v6_pairs_final.json", picks56),
        ...
        ("v9", "v9_pairs_final.json", picks56), ("v10b", "v10b_pairs_final.json", picks56), ("v11", "v11_pairs_final.json", picks56)]
LF = {"v3": "labels_owner_v3.json", "v5": "labels_owner_v5.json", "v6": "labels_owner_v6.json", "v7": "labels_owner_v7.json", "v7.5": "labels_owner_v75.json",
      "v8": "labels_owner_v8.json", "v9": "labels_owner_v9.json", "v10b": "labels_owner_v10b.json", "v11": "labels_owner_v11.json"}
rows = []
...
out["aa_paired_quiz"] = paired(lambda r: r["kind"] == "aa" and r["set"] != "v1", "三b、机机局（只算测验卷 v3–v11）")
...
sets_order = ["v5", "v6", "v7", "v8", "v9", "v10b", "v11"]
...
print("\n== 九、按卷时间线 ==")
tl = []
for name in ["v3", "v5", "v6", "v7", "v8", "v9", "v10b", "v11"]:
