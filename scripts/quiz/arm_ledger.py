...
# 输出 arm_ledger_v5_v12.json（09-22 加 v12；v11 版留档）：arm_aa（AI 对 AI 胜/场）、arm_ha（反杀/场）、pair（逐对矩阵，键按字母序，值=[前者胜, 决定票]）、
...
json.dump(out, open("arm_ledger_v5_v12.json", "w"), ensure_ascii=False, indent=1)
