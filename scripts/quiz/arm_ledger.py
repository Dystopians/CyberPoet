...
# 输出 arm_ledger_v5_v14.json（09-22 加 v12–v14；旧版留档）：arm_aa（AI 对 AI 胜/场）、arm_ha（反杀/场）、pair（逐对矩阵，键按字母序，值=[前者胜, 决定票]）、
...
SETS = [("v5", "v5_pairs_final.json", "labels_owner_v5.json"), ("v6", "v6_pairs_final.json", "labels_owner_v6.json"),
        ...
        ("v11", "v11_pairs_final.json", "labels_owner_v11.json"), ("v12", "v12_pairs_final.json", "labels_owner_v12.json"),
        ("v13", "v13_pairs_final.json", "labels_owner_v13.json"), ("v14", "v14_pairs_final.json", "labels_owner_v14.json")]
...
json.dump(out, open("arm_ledger_v5_v14.json", "w"), ensure_ascii=False, indent=1)
